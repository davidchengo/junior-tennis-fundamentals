(async function () {
  ...
  try {
    ...
    document.getElementById('pageIntro').textContent = role === 'coach' ? 'Manage player profiles and assessments.' : 'View current and previous assessments for your players.';
